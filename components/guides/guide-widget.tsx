    ...
    return (
        <section className="rounded-[2rem] bg-minuri-white p-6 shadow-sm ring-1 ring-minuri-silver/40 md:p-8">
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div>
                    <p className="text-xs font-medium uppercase tracking-[0.16em] text-minuri-teal">
                        Demo widget
                    </p>
                    <h2 className="mt-2 text-xl font-semibold tracking-tight text-minuri-ocean">
                        {widget.title}
                    </h2>
                ...
                {visibleItems.map((item) => (
                    ...
                    >
                        <div className="flex items-center justify-between gap-3">
                            <h3 className="text-base font-semibold text-minuri-ocean">
                                {item.name}
                            </h3>
                        ...
                        <p className="mt-2 text-xs font-medium text-minuri-mid">
                            {item.area}
                        </p>
                        <p className="mt-3 text-xs leading-5 text-minuri-slate">
                            {item.detail}
                        </p>
                        <p className="mt-3 text-xs leading-5 text-minuri-slate">
                            {item.note}
